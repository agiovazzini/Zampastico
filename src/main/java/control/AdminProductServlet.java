...
public class AdminProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if ("create".equals(action)) {
                ...
                response.setContentType("application/json");
                response.getWriter().print("{\"success\":false, \"message\":\"Errore interno del server.\"}");
            }
        }
    }
    ...
    private void handleCreate(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception {
        ...
        if ("new".equals(catParam)) {
            ...
            String nomeSupercategoria = request.getParameter("nuovaSupercategoria");
            int idSuper = 0; 
            if (nomeSupercategoria != null && !nomeSupercategoria.trim().isEmpty()) {
                nomeSupercategoria = nomeSupercategoria.trim();
